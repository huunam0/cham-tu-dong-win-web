...
begin
  ...
  if ((ta2=0) and  (ta1<>0)) or ((tb2=0) and (tb1<>0)) then
  begin
    tmp:=ta1; ta1:=ta2; ta2:=tmp;
    tmp:=tb1; tb1:=tb2; tb2:=tmp;
  end else begin check:=true; exit; end;
  if ta1/ta2<>tb1/tb2 then check:=true else check:=false;
end;
