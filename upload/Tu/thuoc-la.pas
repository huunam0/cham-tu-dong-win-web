...
BEGIN
        ...
        if st<>'' then
                begin
                        ...
                        for i:=1 to d1 do
                                if (b[i]<>'') then
                                        inc(dem1);
                        if (dem mod 2=0)and(dem>1) then
                           begin
                                if ((dem1 mod 2=0) and (dem<=dem1))or(dem1 mod 2<>0)or(dem1=0) then
                                        begin
                                                max1:=dem div 2;
                                                for i:=1 to d do
                                                        c1[i]:=a[i];
                                        ...
                                        if (dem1 mod 2=0)and(dem1>0) then
                                                begin
                                                max1:=dem1 div 2;
                                                for i:=1 to d1 do
                                                        c1[i]:=b[i];
                        ...
                        if (dem mod 2=0)and(dem>0) then
                           begin
                                if ((dem1 mod 2=0)and(dem<dem1))or(dem1 mod 2<>0)or(dem1=0) then
                                        ...
                                        if (dem1 mod 2=0)and(dem1>1) then
                                                begin
                                                        max2:=dem1 div 2;
                                                        for i:=1 to d1 do
                                                                c2[i]:=b[i];
        ...
        { ----------------------------------------------------------------}
        if ((max1 < max2)and(max1>0))or((max2=0)and(max1>0)) then
                begin
                        lon:=max1;
                        for i:=1 to length(s)-1 do
                                c[i]:=c1[i];
